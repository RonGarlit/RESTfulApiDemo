...
using DVDStore.Common.PropertyMapping.v1_0;
...
namespace DVDStore.DAL.Repositories.v1_0
{
    ...
    public class DvdStoreRepository : IDvdStoreRepository, IDisposable
    {
        ...
        // Holds the Property Mapper object for the repository items
        // generating PagedList object in conjunction with passed in
        // specific object "Resource Parameters"
        ...
        /// <param name="actorId"></param>
        /// <returns>
        ///     Actor object with nested collection of the FilmActor and Films
        ///     tables
        /// </returns>
        public Actor GetActorByIdWithFilmListing(int actorId)
        {
            if (actorId != 0)
            {
                // LINQ to include the nested one to many collection.
                // not the bridge table called FilmActors which is the Actor
                // and Film tables have a one to many relation with (Many to Many)
        ...
        /// <param name="lastname"></param>
        /// <returns>
        ///     IEnumerable List of ActorFilmListing class
        /// </returns>
        ...
        /// <param name="actorId"></param>
        /// <returns>
        ///     IEnumerable List of the ActorFilmListing class
        /// </returns>
        ...
        public PagedList<Actor> GetActors(ActorResourceParameters actorResourceParameters)
        {
            ...
            // Check and run for the search parameter and get the collection
            // for columns we have chosen to allow search-able
        ...
        /// <param name="actorResourceParameters"></param>
        /// <returns>
        ///     PagedList of the ActorFilmListing class
        /// </returns>
...
#pragma warning restore CA2208 // Instantiate argument exceptions correctly
        ...
        /// <returns>
        ///     Gets a single film object by Id
        /// </returns>
        ...
        /// <param name="filmId"></param>
        /// <returns>
        ///     Gets a single film object for specific actor
        /// </returns>
        ...
        /// </summary>
        /// <returns>
        ///     IEnumerable List of the Film class
        /// </returns>
